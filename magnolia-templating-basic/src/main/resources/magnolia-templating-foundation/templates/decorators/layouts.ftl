[#include "/magnolia-templating-foundation/templates/macros/seo.ftl" /]
...
<!--[if gt IE 8]><!--> <html lang="${cmsfn.language()}" class="no-js"> <!--<![endif]-->
  <head>
    ...
    <link rel="stylesheet" href="${contextPath}/static/themes/${model.siteTheme!'standard'}/css/theme.css">
    ...
    <script>
        ...
        mtf.themeName = "${model.siteTheme!'standard'}"
