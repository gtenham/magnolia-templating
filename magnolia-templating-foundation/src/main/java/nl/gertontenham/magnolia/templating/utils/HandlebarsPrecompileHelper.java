...
/**
 * Created by gtenham on 2015-07-12.
 */
/**
 ...
 * @since 0.6.0
 */
public final class HandlebarsPrecompileHelper implements Helper<String> {
     ...
     */
    public static final Helper<String> INSTANCE = new HandlebarsPrecompileHelper();

    /**
     * Not allowed.
     */
    private HandlebarsPrecompileHelper() {
    }
